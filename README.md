...
![image](https://github.com/gillohsylvia/AirBnB_clone/assets/104779232/94b914d6-5ce9-4595-b7b3-dc470f7ec85f)
...
**Solution** [models/base_model.py, models/__init__.py, tests/](models/base_model.py, models/__init__.py, tests/)
...
**Solution**  [models/base_model.py, tests/](models/base_model.py, tests/)
```
...
* __simple Python__ data structure: Dictionaries, arrays, number and string. ex: `{ '12': { 'numbers': [1, 2, 3], 'name': "John" } }`
...
**Solution**  [models/engine/file_storage.py, models/engine/__init__.py, models/__init__.py, models/base_model.py, tests/](models/engine/file_storage.py, models/engine/__init__.py, models/__init__.py, models/base_model.py, tests/)
...
**Solution** [console.py](console.py)
...
**Solution** [models/user.py, models/engine/file_storage.py, console.py, tests/](models/user.py, models/engine/file_storage.py, console.py, tests/)
...
**Solution** [models/state.py, models/city.py, models/amenity.py, models/place.py, models/review.py, tests/](models/state.py, models/city.py, models/amenity.py, models/place.py, models/review.py, tests/)
...
**Solution**  [console.py, models/engine/file_storage.py, tests/](console.py, models/engine/file_storage.py, tests/)
...
**Solution** [console.py](console.log)
```
guillaume@ubuntu:~/AirBnB$ ./console.py
(hbnb) User.count()
2
...
**Solution** [tests/test_console.py](tests/test_console.py)
